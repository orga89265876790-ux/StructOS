...
Object.assign(copy.RU, { allYourProjectTools: 'Все ваши:', detailedProjectAnalysis: 'Детально разобрать проект', contractsUnderReview: 'Договоры на рассмотрении', estimatesUnderReview: 'Сметы на рассмотрении', turnkeyObject: 'Сдать объект под ключ', projectMailings: 'Рассылки предложений', mailWorkOffers: 'Рассылка предложений на работу', mailContractOffers: 'Рассылка предложений взять подряд', mailSupplyOffers: 'Рассылка предложений на поставку', projectMenuPrepared: 'Кнопка «{name}» подготовлена. Наполним этот раздел следующим этапом.' });
Object.assign(copy.EN, { allYourProjectTools: 'All yours:', detailedProjectAnalysis: 'Detailed project analysis', contractsUnderReview: 'Contracts under review', estimatesUnderReview: 'Estimates under review', turnkeyObject: 'Submit a turnkey object', projectMailings: 'Offer mailings', mailWorkOffers: 'Send job offers', mailContractOffers: 'Send contract offers', mailSupplyOffers: 'Send supply offers', projectMenuPrepared: 'The “{name}” button is ready. We will build out this section next.' });
Object.assign(copy.KY, { allYourProjectTools: 'Сиздикинин баары:', detailedProjectAnalysis: 'Долбоорду толук талдоо', contractsUnderReview: 'Каралуудагы келишимдер', estimatesUnderReview: 'Каралуудагы сметалар', turnkeyObject: 'Объектти ачкыч менен тапшыруу', projectMailings: 'Сунуштарды жөнөтүү', mailWorkOffers: 'Жумуш сунуштарын жөнөтүү', mailContractOffers: 'Подряд алуу сунуштарын жөнөтүү', mailSupplyOffers: 'Жеткирүү сунуштарын жөнөтүү', projectMenuPrepared: '«{name}» баскычы даяр. Бул бөлүмдү кийинки этапта толтурабыз.' });
Object.assign(copy.TJ, { allYourProjectTools: 'Ҳамаи шумо:', detailedProjectAnalysis: 'Таҳлили муфассали лоиҳа', contractsUnderReview: 'Шартномаҳо дар баррасӣ', estimatesUnderReview: 'Сметаҳо дар баррасӣ', turnkeyObject: 'Супоридани объект бо калид', projectMailings: 'Фиристодани пешниҳодҳо', mailWorkOffers: 'Фиристодани пешниҳодҳои корӣ', mailContractOffers: 'Фиристодани пешниҳодҳои пудратӣ', mailSupplyOffers: 'Фиристодани пешниҳодҳои таъминот', projectMenuPrepared: 'Тугмаи «{name}» омода аст. Ин бахшро дар марҳилаи навбатӣ пур мекунем.' });
